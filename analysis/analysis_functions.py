...
compound_variables = [f'electrical_e{container}_{var}_{phase}' for container,var,phase in product(range(1,9),["voltage","current", "power"],["L1","L2","L3"])]
hub_variables = [f'electrical_thermo_cabinet_{var}_{phase}' for var,phase in product(["voltage","current", "power"],["L1","L2","L3"])]
...
electrical_groups = {
    ...
    "AC_power": ["electrical_vebus_e1_output_power",
