...
export interface Setpoints {
  ...
  coolingSupplyEnabledTime: string;
  chillMinSupplyTemperature: number;
  minimumPreheatOffset: number;
  wasteTargetTemperature: number;
  waterTreatmentMaxFillRatio: number;
  waterTreatmentMinFillRatio: number;
  technicalWaterMaxFillRatio: number;
  technicalWaterMinFillRatio: number;
  freshWaterMinFillRatio: number;
