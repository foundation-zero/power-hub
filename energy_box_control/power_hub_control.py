...
from energy_box_control.monitoring.checks import service_checks, pump_alarm_checks
...
async def run(steps: Optional[int] = None):
    ...
    monitor = Monitor(url_health_checks=service_checks, alarm_checks=pump_alarm_checks)
