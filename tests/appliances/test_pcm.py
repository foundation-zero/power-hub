...
def test_nothing(pcm, simulationtime):
    initial_state = PcmState(0, 10)
    state, outputs = pcm.simulate({}, initial_state, None, simulationtime)
    assert state == initial_state
    assert outputs == {}


def test_zero_flow(pcm, simulationtime):
    initial_state = PcmState(0, 0)
    state, outputs = pcm.simulate(
        {PcmPort.CHARGE_IN: ConnectionState(0, 0)}, initial_state, None, simulationtime
    )
...
def test_charge_pre_phase(pcm, simulationtime):
    initial_state = PcmState(0, 0)
    state, outputs = pcm.simulate(
        {PcmPort.CHARGE_IN: ConnectionState(1, 10)}, initial_state, None, simulationtime
    )
...
def test_charge_transfer_limit(pcm, simulationtime):
    initial_state = PcmState(0, 0)
    state, outputs = pcm.simulate(
        {PcmPort.CHARGE_IN: ConnectionState(1, 40)}, initial_state, None, simulationtime
    )
...
def test_charge_phase(pcm, simulationtime):
...
def test_charge_post_phase(pcm, simulationtime):
    initial_state = PcmState(1, 50)
    state, outputs = pcm.simulate(
        {PcmPort.CHARGE_IN: ConnectionState(1, 60)}, initial_state, None, simulationtime
    )
...
def test_charge_through_phase(high_transfer_pcm, simulationtime):
    initial_state = PcmState(0, 0)
...
def test_discharge_pre_phase(pcm, simulationtime):
...
def test_discharge_phase(high_transfer_pcm, simulationtime):
    initial_state = PcmState(1, 50)
    state, outputs = high_transfer_pcm.simulate(
...
def test_discharge_post_phase(pcm, simulationtime):
...
def test_charge_and_discharge(pcm, simulationtime):
...
def test_limited_charge_and_discharge(pcm, simulationtime):
    initial_state = PcmState(0.5, 50)
    state, outputs = pcm.simulate(
        {
            PcmPort.CHARGE_IN: ConnectionState(10, 40),
