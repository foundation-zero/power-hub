...
def test_half_valve(pipes_pcm_circuit, initial_state_half_valve, min_max_temperature):
...
def test_simple_control(pipes_pcm_circuit, initial_state_pipes_to_pcm_warm):
