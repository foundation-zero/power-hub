...
def initial_state_without_valve(pipes_pcm_circuit):
    return (
        ...
        .value(HeatPipesState(AMBIENT_TEMPERATURE))
        .define_state(pipes_pcm_circuit.heat_pipes_power_hub_pump)
...
def control_pump_on(pipes_pcm_circuit):
    return (
        pipes_pcm_circuit.control(pipes_pcm_circuit.heat_pipes_power_hub_pump)
